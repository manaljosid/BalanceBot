/*
 *  Title: BNO055 Library registers
...
/// @brief Structure to represent revisions
typedef struct {
...
/// @brief Structure to represent offsets
typedef struct {
